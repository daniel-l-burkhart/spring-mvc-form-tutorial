...
/**
 * Implementation of UserDAO interface. Class used to work with database
 *
 * @author daniel
 * @version 1.0
 */
...
public class UserDaoImpl implements UserDao {
    ...
    public List<User> findAll() {
        ...
        List<User> result = this.namedParameterJdbcTemplate.query(sql, new UserMapper());
    ...
    public void save(User user) {
        ...
        this.namedParameterJdbcTemplate.update(sql, getSqlParameterByModel(user), keyHolder);
    ...
    public void update(User user) {
        ...
        this.namedParameterJdbcTemplate.update(sql, getSqlParameterByModel(user));
    }
